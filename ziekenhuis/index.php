...
$patient = new Patient("Erik Van der Wiel", "Blauw", "Bruin", 180, 75);
$doctor = new Doctor("Doktor, Allstar", "Groen", "Zwart", 185, 80, 50);
$nurse = new Nurse("Zuster Julia", "Bruin", "Blond", 170, 60, 30);
...
echo "Tijd: " . $appointment->getDurationInHours() . " hours<br>";
